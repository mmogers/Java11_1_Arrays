...
// helps readability
        ...
        System.out.println("Printing a multi-dimensional array using " +
                "Arrays.deepToString()");
        System.out.println(Arrays.deepToString(variableCols));
...
// Arrays.copyOf works here, but need to cast back to 2-d array
        ...
        System.out.println("-------------------------------------------");
// Comparing our arrays, row 3.... //same references to rows
...
// We can take our shallow copy and make it 'deep' manually.
        for (int i = 0; i < clonedArray.length; i++) {
            clonedArray[i] = clonedArray[i].clone();  // clone each element to change the reference
        }
